...
## 🙈 해멧던 이유
이진탐색 시에 end를 주어진 K개 랜선 중 최솟값으로 설정하여 풀었던 것이 발목을 잡았다.  
최솟값으로 세팅하면 아래와 같이 주어졌을 땐, 최대길이를 제대로 구할 수 없었다.  
초기값 세팅에 따라 전혀 다른 결과가 나올 수 있다는 것을 깨달았고,, 초기값 세팅에 신중하자.
```
2 1
100
1
